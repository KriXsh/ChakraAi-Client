...
const SignUp: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert("Check the console for form data. In a real app, this would register the user.");
  };
    ...
    <AuthLayout>
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 mt-2">Get started with the future of vehicle intelligence.</p>
        </div>
